<div align="center"> <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&duration=3000&pause=800&color=CCCCCC&center=true&vCenter=true&width=560&lines=B.Tech+CSE+in+Blockchain+Technology;Building+EDITKAR%2C+an+AI+Video+Editing+SaaS;Co-built+EV+Carwale+with+Impact+India;Solidity%2C+Ethereum%2C+Hyperledger+Fabric;Always+shipping+something." alt="Typing SVG" /> <h1 style="font-size:52px; font-weight:800; letter-spacing:1px; margin-top:20px;">Shivam Kashyap</h1> <br/>
...
You can check out EVCarwale on - https://www.evcarwale.com/
